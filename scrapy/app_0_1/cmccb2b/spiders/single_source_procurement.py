...
class SingleSourceProcurementSpider(scrapy.Spider):
    name = 'single_source_procurement'
    query_url = 'https://b2b.10086.cn/b2b/main/listVendorNoticeResult.html?noticeBean.noticeType=1'
