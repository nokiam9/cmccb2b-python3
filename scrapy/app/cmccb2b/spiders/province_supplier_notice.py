...
class ProvinceSupplierNoticeSpider(scrapy.Spider):
    name = 'ProvinceSupplierNotice'
    ...
    def start_requests(self):  # 用start_requests()方法,代替start_urls
        ...
        self.form_data = {
            ...
            'noticeBean.companyType': 'province,professional',  # or 'hq'
    ...
    def parse(self, response):
        ...
        for tr in table.xpath("tr[position() > 2]"):
            ...
            try:
                ...
                item['source_ch'] = tr.xpath("td[2]/text()").extract_first()
