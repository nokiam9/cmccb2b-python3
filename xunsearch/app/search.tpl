  ...
  <div class="row">
      ...
      <form class="form-search" id="q-form" method="get">
        ...
        <div class="condition" id="q-options">
          <label class="radio inline"><input type="radio" name="f" value="title" <?php echo $f_title; ?> />Title</label>
			<label class="radio inline"><input type="radio" name="f" value="source_ch" <?php echo $f_source_ch; ?> />Source_ch</label>
			<label class="radio inline"><input type="radio" name="f" value="published_date" <?php echo $f_published_date; ?> />Published_date</label>
          ...
          <select name="s" size="1">
			...
			<option value="published_date_DESC" <?php echo $s_published_date_DESC; ?>>Published_date从大到小</option>
					<option value="published_date_ASC" <?php echo $s_published_date_ASC; ?>>Published_date从小到大</option>
          </select>
          排序
		</div>
      </form>
    ...
    <div class="span12">
      ...
      <dl class="result-list">
        ...
        <dt>
          <a href="javascript:void(alert('pid: <?php echo $doc->nid; ?>'));"><h4><?php echo $doc->rank(); ?>. <?php echo $search->highlight(htmlspecialchars($doc->title)); ?> <small>[<?php echo $doc->percent(); ?>%]</small></h4></a>          
        </dt>
        <dd>
          ...
          <p class="field-info text-error">
            <span><strong>Source_ch:</strong><?php echo htmlspecialchars($doc->source_ch); ?></span>
				<span><strong>Published_date:</strong><?php echo htmlspecialchars($doc->published_date); ?></span>
          </p>
        </dd>
        <?php endforeach; ?>
      </dl>
